...
config.firstLevelDir = 'Z:\Lab_Projects\PTSD_Subtyping_fMRI_MEG\Initial_Analysis_Jan24\data\GoNoGo_First_Level';
config.secondLevelDir='Z:\Lab_Projects\PTSD_Subtyping_fMRI_MEG\Initial_Analysis_Jan24\data\GoNoGo_Second_Level';
config.dataDir = 'Z:\Lab_Projects\PTSD_Subtyping_fMRI_MEG\Initial_Analysis_Jan24\data\BIDS\derivatives';
config.isConstProtocol = false;
config.protocolFolder = 'Z:\Lab_Projects\PTSD_Subtyping_fMRI_MEG\Initial_Analysis_Jan24\data\eventfiles\emotionalgonogo';
config.timeUnits = 'secs';
config.TR = 1;
config.smoothFilePrefix = 's';
config.smoothFunctionalFileTemplate = 'ss*emotionalgonogo*MNI152NLin2009cAsym_res-2_desc-preproc_bold';
config.originalFunctionalFileTemplate = '*emotionalgonogo*MNI152NLin2009cAsym_res-2_desc-preproc_bold';
config.useToExtractRun = '_space';
config.numOfInitialTRsToRemove =0; 
config.fmri_t = 16;
config.fmri_t0 = 8;
config.sessions = {""};
config.subjectsToExclude = [];
config.subjectsToAnalyse = [1807];
...
config.scrubbingStatFileName = 'fd_stats_gonogo.CSV';

%% For First Level & Protcolos
% projectConfigFile='Z:\Lab_Projects\PTSD_Subtyping_fMRI_MEG\Initial_Analysis_Jan24\scripts\GoNoGo_Configuration.m'
% runParallel=false
%
% % For createContrasts
...
% covariatesFiles={}
% resultsFolder='Baseline_Choose&False_Apr20'
% maskFilePath={}
